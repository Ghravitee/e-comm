...
//   const { orders, isLoading, error, loadOrders, clearOrders } = useOrderStore();
//   const [activeFilter, setActiveFilter] = useState<string>("all");
//   const [selectedOrderId, setSelectedOrderId] = useState<string | null>(null);
//   const [isRefreshing, setIsRefreshing] = useState(false);

//   // Load orders when user is available (always load on page load)
//   useEffect(() => {
//     if (user) {
//       loadOrders(user.id, false);
...
//       clearOrders();
//     }
//   }, [user, authLoading, loadOrders, clearOrders]);
...
//             className="mt-6 px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary/80 transition-colors flex items-center gap-2 mx-auto"
//           >
